...
{
    public class GetBookmarksByUserIdQueryHandler : IRequestHandler<GetBookmarksByUserIdQuery, List<BookmarkDto>>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IMapper _mapper;

        public GetBookmarksByUserIdQueryHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
