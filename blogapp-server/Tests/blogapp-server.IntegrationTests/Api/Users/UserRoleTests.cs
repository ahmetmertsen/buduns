...
using User = blogapp_server.Domain.Entities.Identity.User;

namespace blogapp_server.IntegrationTests.Api.Users;

public sealed class UserRoleTests : IntegrationTestBase
{
    public UserRoleTests(BlogAppWebApplicationFactory factory) : base(factory)
    {
    }
